...
ORDER BY 1;
--Traga os funcionarios que trabalham
...
--O gestor de marketing pediu a lista das funcionarias que trabalham no departamento
--de filmes ou no departamento lar. Ele necessita enviar um email para as colaboradoras
-- desses dois setores.

SELECT idFuncionario, NOME, SEXO, DEPARTAMENTO, EMAIL FROM funcionarios
WHERE (departamento = 'Lar' 
OR departamento = 'Filmes')
AND sexo = 'Feminino'; 

--Traga os funcionarios do sexo masculino
--ou os funcionarios que trabalham no setor Jardim. 
